    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="mx-auto grid max-w-[1240px] grid-cols-1 items-center gap-12 px-6 pb-24 pt-[130px] sm:px-10 sm:pt-[150px] lg:grid-cols-2">
        ...
        <div className="relative hidden h-[520px] lg:block">
          {/* terminal card (back left) */}
          <div
            className="absolute -left-2.5 top-9 w-[290px] overflow-hidden rounded-2xl border-[1.5px] border-foreground bg-[#16110B] shadow-[0_4px_0_var(--foreground)]"
            style={
              {
                "--rot": "-6deg",
          ...
          {/* bento card (back right) */}
          <div
            className="absolute -right-1.5 top-0 w-[250px] rounded-2xl border-[1.5px] border-foreground bg-[#F3E8D6] p-4 shadow-[0_4px_0_var(--foreground)]"
            style={
              {
                "--rot": "5deg",
          ...
          >
            <div className="mb-2 flex items-baseline justify-between">
              ...
              <span className="font-mono text-[8px] text-[#A0713C]">
                6 tools
              </span>
            </div>
          ...
          {/* minimal card (front center) */}
          <div
            className="absolute left-[70px] top-[150px] w-[330px] rounded-[18px] border-[1.5px] border-foreground bg-[#FBF7F0] p-[9px] shadow-[0_6px_0_var(--foreground),0_24px_48px_rgba(60,40,10,0.18)]"
            style={
              {
                "--rot": "-1deg",
